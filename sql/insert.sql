insert into categories (category) values ('Smartphone');
insert into categories (category) values ('Web');
insert into categories (category) values ('IOS');
insert into categories (category) values ('Desktop');
insert into categories (category) values ('Mac');
insert into categories (category) values ('Linux');
insert into categories (category) values ('Windows Phone');

insert into types (project_type) values ('Social network');
insert into types (project_type) values ('Word processing software');
insert into types (project_type) values ('Database software');
insert into types (project_type) values ('Spreadsheet software');
insert into types (project_type) values ('Multimedia software');
insert into types (project_type) values ('Presentation Software');
insert into types (project_type) values ('Enterprise Software');
insert into types (project_type) values ('Information Worker Software');
insert into types (project_type) values ('Educational Software');
insert into types (project_type) values ('Simulation Software');
insert into types (project_type) values ('Content Access Software');
insert into types (project_type) values ('Application Suites');
